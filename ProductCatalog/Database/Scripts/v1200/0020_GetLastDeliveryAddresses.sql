/****** Object:  StoredProcedure [prod].[GetLastDeliveryAddresses]    Script Date: 03/06/2014 12:37:40 ******/
SET ANSI_NULLS ON
GO
    ...
    from (
        ...
        from (
            select
                ...
                DeliveryInfo.value('(/DeliveryInfo/Address/AddressKladrCode)[1]', 'nvarchar(256)') as AddressKladr,
