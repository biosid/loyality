...
select @deleteJobId = job_id from msdb.dbo.sysjobs where (name = N'UpdateIndexes')
...
exec @ReturnCode = msdb.dbo.sp_add_jobstep
     ...
     @os_run_priority = 0,
     @subsystem = 'TSQL',
     @command = 'exec [prod].[UpdateIndexes]',
