DELETE [dbo].[EtlPackages]
WHERE [Id] = N'77a3e3c6-c00b-41ff-8376-dcef0df79a00'

INSERT [dbo].[EtlPackages] ([Id], [Name], [Text], [RunIntervalSeconds], [Enabled]) VALUES (N'77a3e3c6-c00b-41ff-8376-dcef0df79a00', N'Импорт стоимости доставки', N'<?xml version="1.0" encoding="utf-16"?>
  ...
  <Steps>
    ...
    <ImportCsvFile>
      ...
      <Mappings>
        ...
        <Mapping>
          <SourceFieldName>PartnerDeliveryRateId</SourceFieldName>
          <DestinationFieldName>PartnerDeliveryRateId</DestinationFieldName>
        </Mapping>
      </Mappings>
