...
--<ArrayOfProductParam>
--  <ProductParam>
--    <Name>“ип процессора</Name>
--    <Value>Atom</Value>
--  </ProductParam>
--  <ProductParam>
--    <Name>–азмер оперативной пам€ти</Name>
--    <Unit>ћб</Unit>
--    <Value>2048</Value>
--  </ProductParam>
--  <ProductParam>
...
--таблица дл€ иденттификаторов всех новых категорий и их родителей
...
-- если поиск с подкатегори€ми добавл€ем все дочерние категории
...
-- если поиск без подкатегорий добавл€ем только переданные категории
else
begin
	insert into #newCatIds
...
BEGIN
	...
	-- ƒобавл€ем вычисление цены доставки дл€ заданого кол-ва товаров.
