...
BEGIN
	set @deliveryPriceJoin = ' CROSS APPLY (SELECT NULL AS [Price], null as CarrierId, null as [ExternalLocationId]) delivery'
...
BEGIN
	...
	set @priceApply = ' APPLY ( select top 1 Price, CarrierId, [ExternalLocationId]
