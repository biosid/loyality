...
<EtlPackage xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
  ...
  <Steps>
	...
	<ValidateCsvFileHeader>
	  ...
	  <BadFormatMessage>В файле "{1}" отсутствует заголовок "{0}"</BadFormatMessage>
	  <HeaderColumns>
		<HeaderColumn><Name>Идентификатор города</Name></HeaderColumn>
		<HeaderColumn><Name>Код по КЛАДР</Name></HeaderColumn>
		<HeaderColumn><Name>Населенный пункт</Name></HeaderColumn>
		<HeaderColumn><Name>Минимальный веc</Name></HeaderColumn>
		<HeaderColumn><Name>Максимальный вес</Name></HeaderColumn>
		<HeaderColumn><Name>Стоимость</Name></HeaderColumn>
		<HeaderColumn><Name>Срок доставки</Name></HeaderColumn>
	  </HeaderColumns>
	</ValidateCsvFileHeader>
