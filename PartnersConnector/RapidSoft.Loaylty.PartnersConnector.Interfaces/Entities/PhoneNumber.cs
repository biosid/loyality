namespace RapidSoft.Loaylty.PartnersConnector.Interfaces.Entities
{
    ...
    public class PhoneNumber : ICloneable, IEquatable<PhoneNumber>
    {
        ...
        public bool IsWellFormed()
        {
            ...
            if (this.CityCode.Length + this.LocalNumber.Length != 10)
            {
                return false;
            }

            return DigitsRx.IsMatch(this.CountryCode) && DigitsRx.IsMatch(this.CityCode) && DigitsRx.IsMatch(this.LocalNumber);
        }
