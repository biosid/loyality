namespace RapidSoft.Loaylty.PromoAction.Tests.RuleCalculator
{
	...
	[TestClass]
	public class RuleCalculatorContainEquationEvalTests
	{
		[TestMethod]
		public void ShouldEvalTrue()
		{
			...
			var filter = new filter { Item = new equation { @operator = equationOperator.cn, value = new[] { val1, val2 } } };
		...
		[TestMethod]
		public void ShouldEvalFalseWithNull()
		{
