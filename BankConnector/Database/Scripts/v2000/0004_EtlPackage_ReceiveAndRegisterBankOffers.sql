...
<EtlPackage xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
  ...
  <Steps>
    ...
    <ExecuteQuery>
      ...
      <Source>
        <Text>
          SELECT TOP 1 [FileName] + ''_response'' as ResponseFileName
    ...
    <ExportCsvFile>
      ...
      <Source>
        ...
        <ConnectionString>$(DB)</ConnectionString>
        <ProviderName>System.Data.SqlClient</ProviderName>
        <Text>SELECT [PartnerOrderNum], [ClientId], [OrderActionResult] FROM [dbo].[RegisterBankOffersResponse] WHERE [EtlSessionId] = @sessionId</Text>
        <Parameters>
          <EtlQueryParameter>
            <Name>sessionId</Name>
            <Value>$(SessionId)</Value>
    ...
    <EmailSend>
      ...
      <Message>
        ...
        <AttachmentFileMask>VTB_*.orderRegB_response</AttachmentFileMask>
      </Message>
    </EmailSend>
  </Steps>
</EtlPackage>'
