...
DECLARE @Name NVARCHAR(255) = N'ReceiveAndAppendPersonalMessages'
...
<EtlPackage xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
  ...
  <Name>ReceiveAndAppendPersonalMessages</Name>
  ...
  <Steps>
    ...
    <EmailReceiveImap>
      ...
      <Message>
        ...
        <AttachmentRegExp>^VTB_[1-2][0-9]{3}[0-1][0-9][0-3][0-9]_[0-9]+\.messagePL$</AttachmentRegExp>
      </Message>
      <Destination>
