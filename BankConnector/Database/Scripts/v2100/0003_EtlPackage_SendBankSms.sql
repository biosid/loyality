...
<EtlPackage xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
  ...
  <Steps>
    ...
    <ExportCsvFile>
      ...
      <TimeoutMilliseconds xsi:nil="true" />
      <EndSessionOnEmptySource>false</EndSessionOnEmptySource>
      <Source>
        <Name>Database</Name>
        <ConnectionString>$(DB)</ConnectionString>
        <ProviderName>System.Data.SqlClient</ProviderName>
      ...
      <Destination>
        ...
        <FilePath>$(Temp)\VTB_$(SessionId)\VTB_$(EtlYear)$(EtlMonth)$(EtlDay)_$(TypeCodeInFileName)_@count.sms</FilePath>
    ...
    <EmailSend>
      ...
      <Message>
        ...
        <AttachmentFileMask>VTB_*.sms</AttachmentFileMask>
      </Message>
    </EmailSend>
  </Steps>
</EtlPackage>
