DECLARE @PackageId NVARCHAR(50) = N'7772648e-708f-43d6-8153-c4caa3e2fb05';
DECLARE @Name NVARCHAR(255) = N'SendPromoActions'
  ...
  <Steps>
    ...
    <ExportCsvFile>
      ...
      <Source>
        ...
        CONVERT(VARCHAR(10), [FromDate], 126) AS [FromDate],
        CONVERT(VARCHAR(10), [ToDate], 126) AS [ToDate]
