...
SET @PackageId = N'9517516a-ee80-4963-b326-7ef56efd9691';
...
INSERT [etl].[EtlPackages] ([Id], [Name], [Text], [RunIntervalSeconds], [Enabled]) VALUES (@PackageId, N'SendRegistrationClients'
,@xml, 0, 1)
ELSE
