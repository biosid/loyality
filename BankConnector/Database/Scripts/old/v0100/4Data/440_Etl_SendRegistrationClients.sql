  ...
  <Steps>
    ...
    <ExportCsvFile>
      ...
      <Source>
        ...
        <Text>UPDATE [dbo].[ClientForRegistration] SET [RequestSessionId] = N''$(SessionId)'' OUTPUT inserted.ClientId, inserted.LastName, inserted.FirstName ,inserted.MiddleName, inserted.MobilePhone, inserted.Email WHERE [RequestSessionId] IS NULL</Text>
        <Parameters />
      </Source>
      <Destination>
        <Name>Файл</Name>
