DELETE FROM [etl].[EtlVariables] WHERE [EtlPackageId] = N'E23D8AF7-5916-4907-9D99-D69ED8E7D542';
DELETE FROM [etl].[EtlMessages] WHERE [EtlPackageId] = N'E23D8AF7-5916-4907-9D99-D69ED8E7D542';
DELETE FROM [etl].[EtlSessions] WHERE [EtlPackageId] = N'E23D8AF7-5916-4907-9D99-D69ED8E7D542';
DELETE FROM [etl].[EtlPackages] WHERE [Id]=N'E23D8AF7-5916-4907-9D99-D69ED8E7D542';
GO

/* EtlPackages */
INSERT [etl].[EtlPackages] ([Id], [Name], [Text], [RunIntervalSeconds], [Enabled]) VALUES (N'E23D8AF7-5916-4907-9D99-D69ED8E7D542', N'ReceiveActivateClients'
...
<EtlPackage xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
  ...
  <Name>ReceiveActivateClients</Name>
  ...
  <Steps>
    <EmailReceiveImap>
      ...
      <Message>
        <Filters>
          <ReceiveFilter>
            <SubjectStartsWith>Activate_Receive_</SubjectStartsWith>
          </ReceiveFilter>
        </Filters>
    ...
    <ExportCsvFile>
      ...
      <Source>
        ...
        <ConnectionString>$(DB)</ConnectionString>
        <ProviderName>System.Data.SqlClient</ProviderName>
        <Text>SELECT  ClientId ,          [Status] ,          [Reason]  FROM    [dbo].[ClientForActivation]  WHERE   [EtlSessionId] = @sessionId</Text>
        <Parameters>
          <EtlQueryParameter>
            <Name>sessionId</Name>
      ...
      <Destination>
        <Name>Temp folder</Name>
        <FilePath>$(Temp)\VTB_$(SessionId)\Response\VTB_$(EtlYear)$(EtlMonth)$(EtlDay)_@count.activPL.response</FilePath>
        <CodePage>1251</CodePage>
        <HasHeaders>true</HasHeaders>
        <FieldDelimiter>;</FieldDelimiter>
