DELETE FROM [etl].[EtlVariables] WHERE [EtlPackageId] = N'6dd71e6c-0fd6-4f27-bc3e-abb94921b7cf';
DELETE FROM [etl].[EtlMessages] WHERE [EtlPackageId] = N'6dd71e6c-0fd6-4f27-bc3e-abb94921b7cf';
DELETE FROM [etl].[EtlSessions] WHERE [EtlPackageId] = N'6dd71e6c-0fd6-4f27-bc3e-abb94921b7cf';
DELETE FROM [etl].[EtlPackages] WHERE [Id]=N'6dd71e6c-0fd6-4f27-bc3e-abb94921b7cf';
GO

GO
/* EtlPackages */
INSERT [etl].[EtlPackages] ([Id], [Name], [Text], [RunIntervalSeconds], [Enabled]) VALUES (N'6dd71e6c-0fd6-4f27-bc3e-abb94921b7cf', N'SendOrders'
  ...
  <Steps>
    ...
    <ExportCsvFile>
      ...
      <Source>
        ...
        <Text>SELECT * FROM [dbo].[OrderForPayment]  WHERE   [EtlSessionId] = @sessionId</Text>
        <Parameters>
          <EtlQueryParameter>
            <Name>sessionId</Name>
