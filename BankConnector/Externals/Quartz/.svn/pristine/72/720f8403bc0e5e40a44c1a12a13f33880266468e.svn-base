...
namespace Quartz
{
	...
	public class JobExecutionException : SchedulerException
	{
        ...
        public JobExecutionException(string msg, bool setTriggerError, bool unscheduleAllTriggers, bool unscheduleFiringTrigger)
            : base(msg)
        {
            this.setTriggerError = setTriggerError;
            this.unscheduleAllTriggs = unscheduleAllTriggers;
            this.unscheduleTrigg = unscheduleFiringTrigger;
        }
        ...
        public virtual bool SetTriggerError
        {
            set
            {
                this.setTriggerError = value;
            }
            get
            {
                return this.setTriggerError;
            }
        }
