...
BEGIN
	...
	INSERT INTO [dbo].[EtlMessages] ([EtlPackageId], [EtlSessionId], [LogDateTime], [LogUtcDateTime], [MessageType], [Text])
    VALUES (@EtlPackageId, @EtlSessionId, GETDATE(), GETUTCDATE(),4, N'Перенос данных из [Geopoints].[BUFFER_CityLocation] в [Geopoints].[Location_' + @Date + '] завершен');
	...
	INSERT INTO [dbo].[EtlMessages] ([EtlPackageId], [EtlSessionId], [LogDateTime], [LogUtcDateTime], [MessageType], [Text])
    VALUES (@EtlPackageId, @EtlSessionId, GETDATE(), GETUTCDATE(),4, N'Перенос данных из [Geopoints].[BUFFER_StreetLocation] в [Geopoints].[Location_' + @Date + '] завершен');
	...
	INSERT INTO [dbo].[EtlMessages] ([EtlPackageId], [EtlSessionId], [LogDateTime], [LogUtcDateTime], [MessageType], [Text])
    VALUES (@EtlPackageId, @EtlSessionId, GETDATE(), GETUTCDATE(),4, N'Применение ограничений к [Geopoints].[Location_' + @Date + '] успешно завершено');
END;
GO
