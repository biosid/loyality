...
(
	...
	CREATE NONCLUSTERED INDEX [IX_REGIONID_NAME_LOCATIONTYPE] ON [Geopoints].[Location' + @Date + '] 
	(
		[RegionId] ASC,
		[Name] ASC,
		[LocationType] ASC
	...
	CREATE NONCLUSTERED INDEX [IX_CITYID_NAME_LOCATIONTYPE] ON [Geopoints].[Location' + @Date + '] 
	(
		[CityId] ASC,
		[Name] ASC,
		[LocationType] ASC
	...
	CREATE NONCLUSTERED INDEX [IX_TOWNID_NAME_LOCATIONTYPE] ON [Geopoints].[Location' + @Date + '] 
	(
		[TownId] ASC,
		[Name] ASC,
		[LocationType] ASC
