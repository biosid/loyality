...
END;
GO
[MergeUtilsDropSPIfExistAndCreateSynonym] '[Geopoints].[CreateLocationTable]', '[Geopoints].[CreateLocationTable]';
GO
...
END;
GO
[MergeUtilsDropSPIfExistAndCreateSynonym] '[Geopoints].[RemapKladrView]', '[Geopoints].[RemapKladrView]';
GO
...
END;
GO
[MergeUtilsDropSPIfExistAndCreateSynonym] '[Geopoints].[SaveDataToLocality]', '[Geopoints].[SaveDataToLocality]';
GO
...
END
GO
[MergeUtilsDropSPIfExistAndCreateSynonym] '[Geopoints].[RecreateBaseKlandTable]', '[Geopoints].[RecreateBaseKlandTable]';
GO
...
BEGIN
	...
	IF NOT EXISTS(SELECT TOP(1) Id FROM [Geopoints].[BufferDestinationLocation] WHERE Id = @RussiaId)
		INSERT INTO [Geopoints].[BufferDestinationLocation]
		(
			id,
			locationtype,
...
END;
GO
[MergeUtilsDropSPIfExistAndCreateSynonym] '[Geopoints].[ProcessingKladr]', '[Geopoints].[ProcessingKladr]';
GO
