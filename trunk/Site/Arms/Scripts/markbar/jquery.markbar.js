    ...
    Plugin.prototype =
	{
	    init: function () {
	        ...
	        if (this.options.strong) {
	            html += '<a class="strong">Жирный</a>';
	        }

	        // Add em
	        if (this.options.em) {
	            html += '<a class="em">Наклонный</a>';
	        }

	        // Add h1
	        if (this.options.h1) {
	            html += '<a class="h1">Заголовок 1</a>';
	        }

	        // Add h2
	        if (this.options.h2) {
	            html += '<a class="h2">Заголовок 2</a>';
	        }

	        // Add h3
	        if (this.options.h3) {
	            html += '<a class="h3">Заголовок 3</a>';
	        }

	        // Add ul
	        if (this.options.ul) {
	            html += '<a class="ul">Список</a>';
	        }

	        // Add ol
	        if (this.options.ol) {
	            html += '<a class="ol">Нумерованный список</a>';
	        }

	        // Add a
	        if (this.options.a) {
	            html += '<a class="a">Ссылка</a>';
	        }

	        // Add img
	        if (this.options.img) {
	            html += '<a class="img">Изображение</a>';
	        }

	        // Add blockquote
	        if (this.options.blockquote) {
	            html += '<a class="blockquote">Цитата</a>';
	        }

	        // Add code
	        if (this.options.code) {
	            html += '<a class="code">Код</a>';
	        }
