...
namespace Quartz.Impl
{
    ...
    public class JobDetailImpl : IJobDetail
    {
        ...
        public bool GroupConcurrentExecutionDisallowed
        {
            get { return ObjectUtils.IsAttributePresent(jobType, typeof(GroupDisallowConcurrentExecutionAttribute)); }
        }
        ...
        public override string ToString()
        {
            return string.Format(
                ...
                "JobDetail '{0}':  jobType: '{1} persistJobDataAfterExecution: {2} concurrentExectionDisallowed: {3} groupConcurrentExectionDisallowed {6} isDurable: {4} requestsRecovers: {5}",
                FullName,
                (JobType == null) ? null : JobType.FullName,
                PersistJobDataAfterExecution,
                ConcurrentExecutionDisallowed,
                Durable,
                RequestsRecovery,
                GroupConcurrentExecutionDisallowed);
        }
