DELETE FROM [etl].[EtlVariables] WHERE [EtlPackageId] = N'f2c56eab-2b60-4af2-8712-90f533ee095e';
DELETE FROM [etl].[EtlMessages] WHERE [EtlPackageId] = N'f2c56eab-2b60-4af2-8712-90f533ee095e';
DELETE FROM [etl].[EtlSessions] WHERE [EtlPackageId] = N'f2c56eab-2b60-4af2-8712-90f533ee095e';
DELETE FROM [etl].[EtlPackages] WHERE [Id]=N'f2c56eab-2b60-4af2-8712-90f533ee095e';
GO

GO
/* EtlPackages */
INSERT [etl].[EtlPackages] ([Id], [Name], [Text], [RunIntervalSeconds], [Enabled]) VALUES (N'f2c56eab-2b60-4af2-8712-90f533ee095e', N'ReceiveDetachClients',
  ...
  <Steps>
    ...
    <ImportCsvFileBatch>
      ...
      <Mappings>
        ...
        <Mapping>
          <SourceFieldName>ClientCount</SourceFieldName>
          <DestinationFieldName>ClientCount</DestinationFieldName>
        </Mapping>
      </Mappings>
