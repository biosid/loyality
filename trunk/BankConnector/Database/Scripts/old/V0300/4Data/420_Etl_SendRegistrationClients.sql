DELETE FROM [etl].[EtlVariables] WHERE [EtlPackageId] = N'9517516a-ee80-4963-b326-7ef56efd9691';
DELETE FROM [etl].[EtlMessages] WHERE [EtlPackageId] = N'9517516a-ee80-4963-b326-7ef56efd9691';
DELETE FROM [etl].[EtlSessions] WHERE [EtlPackageId] = N'9517516a-ee80-4963-b326-7ef56efd9691';
DELETE FROM [etl].[EtlPackages] WHERE [Id]=N'9517516a-ee80-4963-b326-7ef56efd9691';
GO

/* EtlPackages */
INSERT [etl].[EtlPackages] ([Id], [Name], [Text], [RunIntervalSeconds], [Enabled]) VALUES (N'9517516a-ee80-4963-b326-7ef56efd9691', N'SendRegistrationClients'
  ...
  <Steps>
    ...
    <ExportCsvFile>
      ...
      <Source>
        ...
        <Text>UPDATE [dbo].[ClientForRegistration] SET [RequestSessionId] = N''$(SessionId)'' OUTPUT inserted.ClientId, inserted.LastName, inserted.FirstName ,inserted.MiddleName, SUBSTRING(inserted.MobilePhone, 2, LEN(inserted.MobilePhone)) AS MobilePhone, inserted.Email, CONVERT(VARCHAR(10), inserted.BirthDate, 120) AS BirthDate  WHERE [RequestSessionId] IS NULL</Text>
        <Parameters />
      </Source>
      <Destination>
        <Name>Файл</Name>
