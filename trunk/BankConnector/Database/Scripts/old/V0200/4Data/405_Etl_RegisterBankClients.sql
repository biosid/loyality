DELETE FROM [etl].[EtlVariables] WHERE [EtlPackageId] = N'64E1E608-C27F-43BB-88FA-4865E7178109';
DELETE FROM [etl].[EtlMessages] WHERE [EtlPackageId] = N'64E1E608-C27F-43BB-88FA-4865E7178109';
DELETE FROM [etl].[EtlSessions] WHERE [EtlPackageId] = N'64E1E608-C27F-43BB-88FA-4865E7178109';
DELETE FROM [etl].[EtlPackages] WHERE [Id]=N'64E1E608-C27F-43BB-88FA-4865E7178109';
GO

/* EtlPackages */
INSERT [etl].[EtlPackages] ([Id], [Name], [Text], [RunIntervalSeconds], [Enabled]) VALUES (N'64E1E608-C27F-43BB-88FA-4865E7178109', N'RegisterBankClients'
  ...
  <Steps>
    <EmailReceiveImap>
      ...
      <Message>
        <Filters>
          <ReceiveFilter>
            <SubjectStartsWith>BankRegistration_Request</SubjectStartsWith>
          </ReceiveFilter>
        </Filters>
