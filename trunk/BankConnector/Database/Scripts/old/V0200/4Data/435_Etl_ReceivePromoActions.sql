DELETE FROM [etl].[EtlVariables] WHERE [EtlPackageId] = N'77500805-8169-4ae6-87a5-7fcae0fbf398';
DELETE FROM [etl].[EtlMessages] WHERE [EtlPackageId] = N'77500805-8169-4ae6-87a5-7fcae0fbf398';
DELETE FROM [etl].[EtlSessions] WHERE [EtlPackageId] = N'77500805-8169-4ae6-87a5-7fcae0fbf398';
DELETE FROM [etl].[EtlPackages] WHERE [Id]=N'77500805-8169-4ae6-87a5-7fcae0fbf398';
GO

/* EtlPackages */
INSERT [etl].[EtlPackages] ([Id], [Name], [Text], [RunIntervalSeconds], [Enabled]) VALUES (N'77500805-8169-4ae6-87a5-7fcae0fbf398', N'Получение данных о акциях'
...
<EtlPackage xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
  ...
  <Name>Получение данных о акциях</Name>
    ...
    <ImportCsvFileBatch>
      ...
      <Mappings>
        ...
        <Mapping>
		 ...
		 <Mapping>
          <SourceFieldName>Approved</SourceFieldName>
          <DestinationFieldName>Approved</DestinationFieldName>
