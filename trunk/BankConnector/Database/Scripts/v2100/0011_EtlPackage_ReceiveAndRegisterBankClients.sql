...
DECLARE @Name NVARCHAR(255) = N'ReceiveAndRegisterBankClients'
...
<EtlPackage xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
  ...
  <Name>ReceiveAndRegisterBankClients</Name>
  ...
  <Steps>
    <EmailReceiveImap>
      ...
      <Message>
        ...
        <AttachmentRegExp>^VTB_[1-2][0-9]{3}[0-1][0-9][0-3][0-9]_[0-9]+\.regB$</AttachmentRegExp>
      </Message>
      <Destination>
