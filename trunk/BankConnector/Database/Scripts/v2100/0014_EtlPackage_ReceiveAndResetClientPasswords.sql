DECLARE @PackageId NVARCHAR(50) = N'9c12e0c1-9b0b-45a8-ae07-3bc490756f37';
DECLARE @Name NVARCHAR(255) = N'ReceiveAndResetClientPasswords'
...
<EtlPackage xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
  <Id>9C12E0C1-9B0B-45A8-AE07-3BC490756F37</Id>
  <Name>ReceiveAndResetClientPasswords</Name>
  ...
  <Steps>
    <EmailReceiveImap>
      ...
      <Message>
        ...
        <AttachmentRegExp>^VTB_[1-2][0-9]{3}[0-1][0-9][0-3][0-9]_[0-9]+\.resetPassPL$</AttachmentRegExp>
      </Message>
      <Destination>
    ...
    <ImportCsvFileBatch>
      ...
      <Destination>
        ...
        <TableName>ClientForBankPwdReset</TableName>
      </Destination>
    ...
    <InvokeMethod>
      ...
      <Source>
        ...
        <MethodName>ResetClientsPasswords</MethodName>
        <Parameters />
      </Source>
    </InvokeMethod>
    ...
    <ExportCsvFile>
      ...
      <Source>
        ...
        <Text>
          ...
          FROM [dbo].[ClientForBankPwdResetResponse]
          WHERE [EtlSessionId] = @sessionId
        </Text>
        <Parameters>
          <EtlQueryParameter>
    ...
    <EmailSend>
      ...
      <Message>
        ...
        <Subject>ResetPassPL_Response_$(EtlYear)_$(EtlMonth)_$(EtlDay)</Subject>
        <AttachmentFileMask>VTB_*.resetPassPL.response</AttachmentFileMask>
      </Message>
    </EmailSend>
