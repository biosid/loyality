namespace RapidSoft.Loaylty.PromoAction.Repositories
{
    ...
    /// <summary>
    /// Страница сущностей, используется вместо <see cref="IList{T}"/> или любой другой коллекции, 
    /// так как последнии не содержат информации о том что в коллекции не все данные.
    /// </summary>
