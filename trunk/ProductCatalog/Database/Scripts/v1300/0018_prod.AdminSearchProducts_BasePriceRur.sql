/****** Object:  StoredProcedure [prod].[AdminSearchProducts]    Script Date: 06/05/2014 13:27:28 ******/
SET ANSI_NULLS ON
GO
...
if @calcTotalCount = 1
	...
	select
		...
		,case when (not p.[BasePriceRur] is null and p.[BasePriceRUR] > p.[PriceRur]) then cast(1 as bit)
			else CAST(0 as bit)
