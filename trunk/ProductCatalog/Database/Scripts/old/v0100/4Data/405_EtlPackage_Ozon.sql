...
VALUES (N'777ff1a8-3fbf-4127-96d3-70a0fa7fd05c', N'Импорт стоимости доставки Озона', N'<?xml version="1.0" encoding="utf-16"?>
  ...
  <Steps>
    ...
    <ImportCsvFile>
      ...
      <Mappings>
        ...
        <Mapping>
          <SourceFieldName>Область</SourceFieldName>
          <DestinationFieldName>Region</DestinationFieldName>
          <DefaultValue>-</DefaultValue>
        </Mapping>
        <Mapping>
          <SourceFieldName>Город</SourceFieldName>
        ...
        <Mapping>
          <SourceFieldName>Тип товара</SourceFieldName>
          <DestinationFieldName>ProductType</DestinationFieldName>
        </Mapping>
        <Mapping>
    ...
    <ExecuteProcedure>
      <Name>Выполнение процедуры подготовки импорта для Озона</Name>
      <TimeoutMilliseconds xsi:nil="true" />
      <Source>
