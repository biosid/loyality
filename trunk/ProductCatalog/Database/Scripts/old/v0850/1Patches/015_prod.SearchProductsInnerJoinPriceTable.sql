/****** Object:  StoredProcedure [prod].[SearchProducts]    Script Date: 24.09.2013 16:19:09 ******/
SET ANSI_NULLS ON
GO
...
set @fromSql = '
		FROM 
			...
			inner join '+@priceTableName+' price on (p.[ProductId] = price.[ProductId] and price.PriceTotal is not null) '
