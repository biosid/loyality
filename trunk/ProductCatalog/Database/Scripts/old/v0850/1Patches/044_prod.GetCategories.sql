/****** Object:  StoredProcedure [prod].[GetCategories]    Script Date: 01.10.2013 16:49:18 ******/
SET ANSI_NULLS ON
GO
...
--declare @catIds nvarchar(MAX) = null  --'321,323,293'
--declare @status int = null
--declare @parentId int = null --99
--declare @nestingLevel int = null
--declare @countToTake int = null
--declare @countToSkip int = null
--declare @calcTotalCount bit = null
--declare @includeParent bit = 0
--declare @locationCode nvarchar(32)
--declare @type int = null
--declare @targetAudiencesIds nvarchar(max) = null
--declare @totalCount int
--declare @childrenCount int
--declare @baseSql nvarchar(MAX)
--declare @actionSql nvarchar(MAX)
--declare @deliveryActionSql nvarchar(MAX)
--declare @deliveryActionQuantitySql nvarchar(MAX)
--declare @contextKey nvarchar(MAX) = 'asdf'
